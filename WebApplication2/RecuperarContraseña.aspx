        ...
        <div class="form-container">
            <form id="form" runat="server">
                ...
                <div class="form-group">
                    <asp:Label ID="lblCorreo" runat="server">Introduce tu correo electrónico*</asp:Label> 
                    <asp:TextBox ID="txtUsuario" runat="server" placeholder="Correo electrónico" MaxLength="50" required=""></asp:TextBox>
                </div>
                <div class="form-group">
                    <asp:Label  ID="lblIntoCode" runat="server"></asp:Label>
                    <div>
                ...
                <div class="form-group">
                    <asp:Label  ID="lblConfirmContra" runat="server"></asp:Label>
